...
SECURE_SSL_REDIRECT = False if DEBUG else get_bool("SECURE_SSL_REDIRECT", default=False)
SESSION_COOKIE_SECURE = False if DEBUG else get_bool("SESSION_COOKIE_SECURE", default=False)
CSRF_COOKIE_SECURE = False if DEBUG else get_bool("CSRF_COOKIE_SECURE", default=False)
